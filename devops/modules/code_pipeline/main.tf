resource "aws_s3_bucket" "source" {
  bucket        = "cleverops-experiment-source"
  acl           = "private"
  force_destroy = true
}
...
resource "aws_codebuild_project" "cleverops_build" {
  name          = "cleverops-codebuild"
  build_timeout = "10"
...
resource "aws_codepipeline" "pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ProjectName = "cleverops-codebuild"
      }
    }
  }
